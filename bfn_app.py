...
def create_prompt(myquestion):
    ...
    prompt = f"""
           ...
           If the CONTEX does not contain the information about the QUESTION simply say: "your question cannot be answered".
...
def main():
    ...
    st.title(f":speech_balloon: :green[Breastfeeding Network Drug in Breastmilk Factsheets' Assistant]")
    st.write(''':violet[Disclaimer: The information provided is taken from various reference sources. It is provided as a guideline.
             ...
             information but cannot replace input from professionals]'''
             )
    ...
    st.button( ":violet[Clear chat]", on_click=init_messages)
